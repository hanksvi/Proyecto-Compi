...
ostream& operator<<(ostream& outs, const Token& tok) {
    switch (tok.type) {
        ...
        case Token::LS:    outs << "TOKEN(LS, \""    << tok.text << "\")"; break;
        case Token::LSEQ:    outs << "TOKEN(LSEQ, \""    << tok.text << "\")"; break;
        ...
        case Token::PROC:    outs << "TOKEN(PROC, \""    << tok.text << "\")"; break;
        case Token::RETURN:    outs << "TOKEN(RETURN, \""    << tok.text << "\")"; break;
        case Token::ASSIGN:    outs << "TOKEN(ASSIGN, \""    << tok.text << "\")"; break;
        case Token::ECHO:    outs << "TOKEN(ECHO, \""    << tok.text << "\")"; break;
        case Token::IF:    outs << "TOKEN(IF, \""    << tok.text << "\")"; break;
        case Token::WHILE:    outs << "TOKEN(WHILE, \""    << tok.text << "\")"; break;
        case Token::NEWLINE:    outs << "TOKEN(NEWLINE, \""    << tok.text << "\")"; break;
        case Token::INDENT:    outs << "TOKEN(INDENT, \""    << tok.text << "\")"; break;
        case Token::DEDENT:    outs << "TOKEN(DEDENT, \""    << tok.text << "\")"; break;
